 ...
 * @author amine
 */
public class AffectéArticle extends javax.swing.JFrame {

    /**
     * Creates new form AffectéArticle
     */
    public AffectéArticle() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AffectéArticle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AffectéArticle().setVisible(true);
            }
        });
    }
